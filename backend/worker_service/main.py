            ...
            for stream_name, stream_messages in messages:
                for message_id, message_data in stream_messages:
                    ...
                    await conn.execute(
                        ...
                        msg_id,
                        decoded_data['model'],
                        decoded_data['provider'],
                        int(decoded_data['latency_ms']),
                        int(decoded_data.get('input_tokens', 0)),
                        int(decoded_data.get('output_tokens', 0)),
                        int(decoded_data.get('total_tokens', 0)),
                        decoded_data['status'],
                        decoded_data.get('error_message') or None,
                        req_ts,
                        resp_ts,
                        input_preview,
                        output_preview
